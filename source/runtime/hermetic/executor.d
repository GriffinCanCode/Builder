module runtime.hermetic.executor;
...
import runtime.hermetic.audit;
import errors;

// Platform-specific imports
version(linux)
{
    import runtime.hermetic.linux;
}
version(OSX)
{
    import runtime.hermetic.macos;
}
version(Windows)
{
    import runtime.hermetic.windows;
}
...
struct HermeticExecutor
{
    ...
    {
        import runtime.hermetic.timeout : createTimeoutEnforcer;
