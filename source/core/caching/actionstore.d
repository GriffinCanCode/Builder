...
struct ActionStorage
{
    ...
    /// Write ActionId
    private static void writeActionId(ref Appender!(ubyte[]) buffer, ref const(ActionId) id) @trusted
    {
    ...
    /// Read ActionId
    private static ActionId readActionId(scope const(ubyte)[] data, ref size_t offset) @trusted
    {
        ActionId id;
    ...
    /// Write string array
    private static void writeStringArray(ref Appender!(ubyte[]) buffer, scope const(string)[] arr) @trusted
    {
    ...
    /// Read string array
    private static string[] readStringArray(scope const(ubyte)[] data, ref size_t offset) @trusted
    {
        immutable ubyte[4] countBytes = data[offset .. offset + 4][0 .. 4];
        immutable count = bigEndianToNative!uint(countBytes);
        offset += 4;
    ...
    private static void writeStringMap(ref Appender!(ubyte[]) buffer, scope const(string[string]) map) @trusted
    {
    ...
    private static string[string] readStringMap(scope const(ubyte)[] data, ref size_t offset) @trusted
    {
        immutable ubyte[4] countBytes = data[offset .. offset + 4][0 .. 4];
        immutable count = bigEndianToNative!uint(countBytes);
        offset += 4;
    ...
    /// Write ActionEntry
    private static void writeActionEntry(T)(ref Appender!(ubyte[]) buffer, ref const(T) entry) @trusted
    {
        // Write ActionId
    ...
    /// Read ActionEntry
    private static T readActionEntry(T)(scope const(ubyte)[] data, ref size_t offset) @trusted
    {
        T entry;
