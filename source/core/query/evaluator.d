...
import core.query.algorithms;
import core.query.operators;
...
{
    import core.query.lexer : QueryLexer;
    import core.query.parser : QueryParser;
    
    // Lex
    auto lexer = QueryLexer(queryString);
    auto tokensResult = lexer.tokenize();
    if (tokensResult.isErr)
        return Result!(BuildNode[], string).err("Lexer error: " ~ tokensResult.unwrapErr());
