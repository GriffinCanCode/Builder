...
class KotlinHandler : BaseLanguageHandler
{
    ...
    private LanguageBuildResult buildExecutable(Target target, WorkspaceConfig config, KotlinConfig ktConfig)
    {
    ...
    private LanguageBuildResult buildLibrary(Target target, WorkspaceConfig config, KotlinConfig ktConfig)
    {
    ...
    private LanguageBuildResult runTests(Target target, WorkspaceConfig config, KotlinConfig ktConfig)
    {
        LanguageBuildResult result;
    ...
    private LanguageBuildResult buildCustom(Target target, WorkspaceConfig config, KotlinConfig ktConfig)
    {
        LanguageBuildResult result;
